...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--red_ratio', type=int, default=0, help='number of red points in the ratio')
        parser.add_argument('--green_ratio', type=int, default=0, help='number of green points in the ration')
        self.isTrain = True
        return parser
